...
$options[]      = array(
  ...
  'fields'      => array(
    ...
    array(
      ...
      'title'   => 'Number',
      'default' => '10',
      'after'   => ' <i class="hfps-text-muted">$ (dollars)</i>',
    ),
    ...
    array(
      ...
      'fields'    => array(
        ...
        array(
          ...
          'after' => ' <i class="hfps-text-muted">( this option is optional )</i>',
        ),
        ...
        array(
          ...
          'before' => '<i class="hfps-text-muted">( important )</i> ',
        ),
        ...
        array(
          ...
          'after' => '<p class="hfps-text-info">Information: There is some description for option.</p> ',
        ),
        ...
        array(
          ...
          'after'      => '<p class="hfps-text-muted">There is custom css <strong>style="width: 175px; height: 40px; border-color: #93C054;"</strong></p>',
        ),
        ...
        array(
          ...
          'after'      => '<p class="hfps-text-muted">There is custom css <strong>style="width: 100%;"</strong></p>'
        ),
        ...
        array(
          ...
          'after'  => '<p class="hfps-text-muted">This Text Field do not using left title, just using before text here. also you can remove it.</h4>',
        ),
    ...
    array(
      ...
      'fields'    => array(
        ...
        array(
          ...
          'after' => '<p class="hfps-text-muted">Information: There is some description for option.</p> ',
        ),
        ...
        array(
          ...
          'before' => '<p class="hfps-text-muted">Information: There is some description for option.</p> ',
        ),
        ...
        array(
          ...
          'after'      => '<p class="hfps-text-muted">custom textarea attribute rows=10</p> ',
        ),
        ...
        array(
          ...
          'after'  => '<p class="hfps-text-muted">This Textarea Field do not using left title, just using before text here. also you can remove it.</h4>',
        ),
    ...
    array(
      ...
      'fields'    => array(
        ...
        array(
          ...
          'after'         => '<p class="hfps-text-muted"><strong>query_args:</strong> sort_order=desc, sort_column=post_title</p>',
        ),
        ...
        array(
          ...
          'after'       => '<div class="hfps-text-muted"><strong>query_args:</strong> post_type=your_post_type_name</div>',
        ),
        ...
        array(
          ...
          'after'       => '<div class="hfps-text-muted"><strong>query_args:</strong> post_type=your_post_type_name, taxonomy=your_taxonomy_name</div>',
        ),
        ...
        array(
          ...
          'after'        => '<div class="hfps-text-muted"><strong>query_args:</strong> taxonomies=your_taxonomy_name, order=asc, orderby=name</div>',
        ),
    ...
    array(
      ...
      'fields'    => array(
        ...
        array(
          ...
          'after'   => '<div class="hfps-text-muted">Reference site about Lorem Ipsum, a random Lipsum generator.</div>',
        ),
    ...
    array(
      ...
      'fields'      => array(
        ...
        array(
          ...
          'after'   => ' <i class="hfps-text-muted">(px)</i>',
        ),
    ...
    array(
      ...
      'fields'      => array(
        ...
        array(
          ...
          'after'   => '<p class="hfps-text-muted">Lets write some description for this icon field.</i>',
        ),
    ...
    array(
      ...
      'fields'    => array(
        ...
        array(
          ...
          'after'   => '<p class="hfps-text-muted">You can use default value <strong>get_template_directory_uri()</strong>."/images/screenshot-1.png"</p>',
        ),
    ...
    array(
      ...
      'fields'      => array(
        ...
        array(
          ...
          'after'   => '<p class="hfps-text-warning">This field using debug=true</p>',
          'debug'   => true,
        ),
...
$options[]   = array(
  ...
  'fields'   => array(
    ...
    array(
      ...
      'type'     => 'text',
      'title'    => 'Requried Text',
      'after'    => ' <small class="hfps-text-warning">( * required )</small>',
      'default'  => 'lorem ipsum',
      'validate' => 'required',
    ),
    ...
    array(
      'type'    => 'notice',
      'class'   => 'info',
      'content' => 'Also you can add your own validate from <strong>themename/hfps-framework/functions/validate.php</strong>',
    ),
...
$options[]   = array(
  ...
  'fields'   => array(
    ...
    array(
      ...
      'after'    => '<p class="hfps-text-muted">This text field sanitized already, without any settings. we are using wordpress core.<br /> for eg. try too add <strong>&lt;p></strong> html tag</p>',
    ),
    ...
    array(
      ...
      'after'    => '<p class="hfps-text-muted">Disabled sanitize for this field (sanitize=false). try too add <strong>&lt;p></strong> html tag so, you can write anything</p>',
      'sanitize' => false,
    ),
    ...
    array(
      ...
      'after'    => '<p class="hfps-text-muted">This textarea field sanitized already, without any settings. we are using wordpress core.<br /> just allowing this tags wp core $allowedposttags</p>',
    ),
    ...
    array(
      ...
      'after'    => '<p class="hfps-text-muted">Disabled sanitize for this field (sanitize=false). you can write anything</p>',
      'sanitize' => false,
    ),
    ...
    array(
      'type'    => 'notice',
      'class'   => 'info',
      'content' => 'Custom Sanitize, Also you can add your own validate from <strong>themename/hfps-framework/functions/sanitize.php</strong>',
    ),
    ...
    array(
      ...
      'after'    => '<p class="hfps-text-muted">This text field sanitized as slug title (sanitize="title")</p>',
      'sanitize' => 'title',
    ),
...
HFPSFramework::instance( $settings, $options );
