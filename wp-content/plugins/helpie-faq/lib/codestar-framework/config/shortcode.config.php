...
$options[]     = array(
  ...
  'shortcodes' => array(
    ...
    // begin: shortcode
    array(
      'name'          => 'hfps_advanced_3',
      'title'         => 'Duplicate Group Shortcode',
      'view'          => 'clone',
      'clone_id'      => 'hfps_advanced_3_sub',
      'clone_title'   => 'Add New',
      'fields'        => array(
...
HFPSFramework_Shortcode_Manager::instance( $options );
