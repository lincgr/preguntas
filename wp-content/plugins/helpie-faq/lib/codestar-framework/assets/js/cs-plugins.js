...
(function($) {
    ...
    /**
     * Microsoft safe helper to spit out our little diagnostihfps information
     *
     * @ignore
     */
    function log(msg) {
...
function($) {
    ...
    var CSTooltip = function(element, options) {
        ...
        this.init('hfpstooltip', element, options)
    }
    ...
    CSTooltip.DEFAULTS = {
        ...
        placement: 'top',
        selector: false,
        template: '<div class="hfps-tooltip" role="tooltip"><div class="hfps-tooltip-arrow"></div><div class="hfps-tooltip-inner"></div></div>',
        trigger: 'hover focus',
        title: '',
        delay: 0,
        html: false,
    ...
    CSTooltip.prototype.setContent = function() {
        ...
        $tip.find('.hfps-tooltip-inner')[this.options.html ? 'html' : 'text'](title)
    ...
    CSTooltip.prototype.arrow = function() {
        return (this.$arrow = this.$arrow || this.tip().find('.hfps-tooltip-arrow'))
    }
    ...
    function Plugin(option) {
        return this.each(function() {
            var $this = $(this)
            var data = $this.data('bs.hfpstooltip')
            var options = typeof option == 'object' && option

            if (!data && /destroy|hide/.test(option)) return
            if (!data) $this.data('bs.hfpstooltip', (data = new CSTooltip(this, options)))
            if (typeof option == 'string') data[option]()
        })
    }

    var old = $.fn.hfpstooltip

    $.fn.hfpstooltip = Plugin
    $.fn.hfpstooltip.Constructor = CSTooltip


    // TOOLTIP NO CONFLICT
    // ===================

    $.fn.hfpstooltip.noConflict = function() {
        $.fn.hfpstooltip = old
        return this
    }
