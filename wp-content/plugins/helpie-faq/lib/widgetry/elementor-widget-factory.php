...
require_once  'elementor-widget-base.php';
...
if (!class_exists('\Widgetry\Elementor_Widget_Factory')) {
    class Elementor_Widget_Factory extends \Widgetry\Elementor_Widget_Base
    {
        protected $name;
        protected $title;
        protected $icon;
